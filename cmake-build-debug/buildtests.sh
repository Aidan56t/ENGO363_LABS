...
then
  C:/PROGRA~1/JETBRA~1/CLION2~1.1/bin/mingw/bin/mingw32-make.exe $targets_to_make ${EIGEN_MAKE_ARGS}
else
  C:/PROGRA~1/JETBRA~1/CLION2~1.1/bin/mingw/bin/mingw32-make.exe $targets_to_make 
fi
exit $?
